...
const SuboxoneDoctor: React.FC = () => {
    usePageMeta(pageMeta['/suboxone-doctor-oxford-ms']);
            ...
            <section className="py-24 bg-dark-green">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    ...
                    <p className="text-lg text-cream mb-10 max-w-xl mx-auto leading-relaxed">
                        Start with a new client intake — most new patients are seen within the same week. No lecture,
                        no script, just a conversation about whether we're a fit.
                    </p>
                    <button
