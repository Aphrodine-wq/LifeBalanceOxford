            ...
            <section className="py-24 bg-dark-green">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    ...
                    <p className="text-lg text-cream mb-10 max-w-xl mx-auto leading-relaxed">
                        Start with a new client intake. Most new patients are seen within the same week. We do this
                        without lectures and without records that follow you anywhere.
                    </p>
                    <button
