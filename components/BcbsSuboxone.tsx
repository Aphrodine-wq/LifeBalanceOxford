            ...
            <section className="py-24 bg-dark-green">
                <div className="max-w-3xl mx-auto px-6 text-center">
                    ...
                    <p className="text-lg text-cream mb-10 max-w-xl mx-auto leading-relaxed">
                        Start with a new client intake — Kim verifies BCBS benefits in under fifteen minutes. We
                        confirm copays, prior auth requirements, and telehealth eligibility before you book.
                    </p>
                    <button
